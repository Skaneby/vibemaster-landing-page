...
const translations = {
  ...
  en: {
    ...
    "faq.q3":             "But isn't Vibemaster just another ChatGPT?",
    "faq.a3":             "Fair question. ChatGPT is a brilliant generalist — but when you want to build a product, you have to know which questions to ask, in what order, and how to stitch the answers into something a coding tool can actually use.<br><br>Vibemaster does the opposite. It interviews <strong>you</strong> with the right questions — user flows, data model, auth, edge cases — and produces a single structured spec that Lovable, Cursor, Bolt or Claude Code can build from directly.<br><br>Think of ChatGPT as a chef you can chat with. Vibemaster is the recipe.",
  ...
  sv: {
    ...
    "faq.q3":             "Men är inte Vibemaster bara ännu en ChatGPT?",
    "faq.a3":             "Bra fråga. ChatGPT är en briljant generalist – men när du vill bygga en produkt måste du veta vilka frågor du ska ställa, i vilken ordning, och hur du sätter ihop svaren till något ett kodverktyg faktiskt kan använda.<br><br>Vibemaster gör tvärtom. Det intervjuar <strong>dig</strong> med rätt frågor – user flows, datamodell, inloggning, edge cases – och producerar en strukturerad spec som Lovable, Cursor, Bolt eller Claude Code kan bygga från direkt.<br><br>Tänk på ChatGPT som en kock du kan prata med. Vibemaster är receptet.",
  ...
  de: {
    ...
    "faq.q3":             "Aber ist Vibemaster nicht einfach noch ein ChatGPT?",
    "faq.a3":             "Berechtigte Frage. ChatGPT ist ein brillanter Generalist – aber wenn du ein Produkt bauen willst, musst du wissen, welche Fragen du stellen sollst, in welcher Reihenfolge und wie du die Antworten zu etwas zusammenfügst, das ein Coding-Tool tatsächlich verwenden kann.<br><br>Vibemaster macht das Gegenteil. Es interviewt <strong>dich</strong> mit den richtigen Fragen – User Flows, Datenmodell, Auth, Edge Cases – und liefert eine strukturierte Spezifikation, die Lovable, Cursor, Bolt oder Claude Code direkt umsetzen können.<br><br>Stell dir ChatGPT als Koch vor, mit dem du plaudern kannst. Vibemaster ist das Rezept.",
  ...
  es: {
    ...
    "faq.q3":             "¿Pero no es Vibemaster simplemente otro ChatGPT?",
    "faq.a3":             "Pregunta justa. ChatGPT es un generalista brillante – pero cuando quieres construir un producto, tienes que saber qué preguntas hacer, en qué orden, y cómo unir las respuestas en algo que una herramienta de programación pueda usar realmente.<br><br>Vibemaster hace lo contrario. Te entrevista a <strong>ti</strong> con las preguntas correctas – flujos de usuario, modelo de datos, autenticación, casos límite – y produce una especificación estructurada que Lovable, Cursor, Bolt o Claude Code pueden construir directamente.<br><br>Piensa en ChatGPT como un chef con el que puedes charlar. Vibemaster es la receta.",
  ...
  fr: {
    ...
    "faq.q3":             "Mais Vibemaster n'est-il pas juste un autre ChatGPT ?",
    "faq.a3":             "Bonne question. ChatGPT est un brillant généraliste – mais quand vous voulez construire un produit, vous devez savoir quelles questions poser, dans quel ordre, et comment assembler les réponses en quelque chose qu'un outil de codage peut vraiment utiliser.<br><br>Vibemaster fait l'inverse. Il <strong>vous</strong> interroge avec les bonnes questions – parcours utilisateurs, modèle de données, authentification, cas limites – et produit une spécification structurée que Lovable, Cursor, Bolt ou Claude Code peuvent construire directement.<br><br>Pensez à ChatGPT comme un chef avec qui vous pouvez discuter. Vibemaster, c'est la recette.",
  ...
  hi: {
    ...
    "faq.q3":             "लेकिन क्या Vibemaster सिर्फ एक और ChatGPT नहीं है?",
    "faq.a3":             "अच्छा सवाल। ChatGPT एक शानदार generalist है – लेकिन जब आप एक product बनाना चाहते हैं, तो आपको पता होना चाहिए कि कौन से सवाल पूछने हैं, किस क्रम में, और जवाबों को कैसे जोड़कर कुछ ऐसा बनाना है जिसे एक coding tool वास्तव में use कर सके।<br><br>Vibemaster इसके विपरीत करता है। यह सही सवालों के साथ <strong>आपका</strong> interview लेता है – user flows, data model, auth, edge cases – और एक संरचित spec produce करता है जिसे Lovable, Cursor, Bolt या Claude Code सीधे बना सकें।<br><br>ChatGPT को एक ऐसे chef की तरह सोचें जिससे आप बात कर सकते हैं। Vibemaster recipe है।",
  ...
  zh: {
    ...
    "faq.q3":             "但 Vibemaster 不就是另一个 ChatGPT 吗？",
    "faq.a3":             "好问题。ChatGPT 是一位出色的通才——但当你想构建一个产品时，你必须知道该问什么问题、按什么顺序问，以及如何把答案拼接成编码工具实际能用的东西。<br><br>Vibemaster 做的恰恰相反。它用正确的问题来访谈<strong>你</strong>——用户流程、数据模型、认证、边缘情况——然后产出一份结构化规格，Lovable、Cursor、Bolt 或 Claude Code 可以直接据此构建。<br><br>把 ChatGPT 想成一位你可以闲聊的大厨。Vibemaster 就是那份食谱。",
