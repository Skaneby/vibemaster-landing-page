...
const translations = {
  ...
  en: {
    ...
    "pricing.studio.f2":    "Shared prompt library",
  ...
  sv: {
    ...
    "pricing.studio.f2":    "Delat promptbibliotek",
  ...
  de: {
    ...
    "pricing.studio.sub":   "Für Teams bis zu 5 Personen.",
    "pricing.studio.cta":   "Testversion starten",
    "pricing.studio.f1":    "Bis zu 5 Team-Plätze",
    "pricing.studio.f2":    "Gemeinsame Prompt-Bibliothek",
  ...
  es: {
    ...
    "pricing.studio.f2":    "Biblioteca de prompts compartida",
  ...
  fr: {
    ...
    "pricing.studio.f2":    "Bibliothèque de prompts partagée",
  ...
  hi: {
    ...
    "pricing.studio.sub":   "5 लोगों तक की टीमों के लिए।",
    "pricing.studio.cta":   "ट्रायल शुरू करें",
    "pricing.studio.f1":    "5 टीम सीटें तक",
    "pricing.studio.f2":    "साझा प्रॉम्प्ट लाइब्रेरी",
  ...
  zh: {
    ...
    "pricing.studio.sub":   "适合最多5人的团队。",
    "pricing.studio.cta":   "开始试用",
    "pricing.studio.f1":    "最多5个团队席位",
    "pricing.studio.f2":    "共享提示词库",
