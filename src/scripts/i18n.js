...
const translations = {
  ...
  en: {
    ...
    "faq.a5":             "Vibemaster's tech plans are powered by <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google Gemini</a> combined with our own proprietary prompt architecture. When you describe your idea, our structured prompts guide Gemini to extract the right technical details — database tables, API routes, user flows, and edge cases — in a consistent, buildable format. The AI tools listed (like Lovable, Bolt.new, and Cursor) are chosen because they are the leading services where Vibemaster-generated plans deliver the best results. We continuously refine our prompts based on what actually works in production.",
  ...
  sv: {
    ...
    "faq.a5":             "Vibemasters tech-planer drivs av <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google Gemini</a> kombinerat med vår egen proprietära promptarkitektur. När du beskriver din idé vägleder våra strukturerade prompts Gemini att extrahera rätt tekniska detaljer — databastabeller, API-rutter, användarflöden och kantfall — i ett konsekvent, byggbart format. De AI-verktyg vi listar (som Lovable, Bolt.new och Cursor) är valda för att de är de ledande tjänsterna där Vibemaster-genererade planer ger bäst resultat. Vi förfinar kontinuerligt våra prompts baserat på vad som faktiskt fungerar i produktion.",
  ...
  de: {
    ...
    "faq.a5":             "Vibemasters Tech-Pläne werden von <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google Gemini</a> in Kombination mit unserer eigenen proprietären Prompt-Architektur angetrieben. Wenn du deine Idee beschreibst, leiten unsere strukturierten Prompts Gemini dazu, die richtigen technischen Details zu extrahieren — Datenbanktabellen, API-Routen, User Flows und Randfälle — in einem konsistenten, baubaren Format. Die aufgeführten KI-Tools (wie Lovable, Bolt.new und Cursor) wurden ausgewählt, weil sie die führenden Dienste sind, bei denen Vibemaster-generierte Pläne die besten Ergebnisse liefern.",
  ...
  es: {
    ...
    "faq.a5":             "Los planes técnicos de Vibemaster están impulsados por <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google Gemini</a> combinado con nuestra propia arquitectura de prompts propietaria. Cuando describes tu idea, nuestros prompts estructurados guían a Gemini para extraer los detalles técnicos correctos — tablas de base de datos, rutas API, flujos de usuario y casos extremos — en un formato consistente y construible. Las herramientas de IA listadas (como Lovable, Bolt.new y Cursor) fueron elegidas porque son los servicios líderes donde los planes generados por Vibemaster ofrecen los mejores resultados.",
  ...
  fr: {
    ...
    "faq.a5":             "Les plans techniques de Vibemaster sont alimentés par <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google Gemini</a> combiné à notre propre architecture de prompts propriétaire. Lorsque tu décris ton idée, nos prompts structurés guident Gemini pour extraire les bons détails techniques — tables de base de données, routes API, flux utilisateurs et cas limites — dans un format cohérent et constructible. Les outils IA listés (comme Lovable, Bolt.new et Cursor) ont été choisis car ce sont les services leaders où les plans générés par Vibemaster donnent les meilleurs résultats.",
  ...
  hi: {
    ...
    "faq.a5":             "Vibemaster के tech plans <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google Gemini</a> द्वारा संचालित हैं, जो हमारी अपनी proprietary prompt architecture के साथ संयुक्त हैं। जब आप अपना विचार वर्णित करते हैं, तो हमारे structured prompts Gemini को सही तकनीकी विवरण निकालने के लिए मार्गदर्शन करते हैं — database tables, API routes, user flows और edge cases — एक सुसंगत, buildable format में। सूचीबद्ध AI tools (जैसे Lovable, Bolt.new और Cursor) इसलिए चुने गए हैं क्योंकि ये वो अग्रणी सेवाएं हैं जहां Vibemaster-generated plans सर्वोत्तम परिणाम देते हैं।",
  ...
  zh: {
    ...
    "faq.a5":             "Vibemaster的技术方案由<a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google Gemini</a>结合我们自有的专利提示架构驱动。当您描述想法时，我们的结构化提示引导Gemini提取正确的技术细节——数据库表、API路由、用户流程和边缘情况——生成一致且可构建的格式。所列AI工具（如Lovable、Bolt.new和Cursor）之所以被选中，是因为它们是Vibemaster生成的方案效果最佳的主流服务。",
