...
const translations = {
  ...
  sv: {
    ...
    "hero.badge":         "Byggt för icke-tekniska grundare, visionärer och kreatörer",
    "hero.h1.a":          "Du kommer med idén. Vi gör den",
    "hero.h1.b":          "byggbar.",
    "hero.h1.c":          "",
    "hero.sub":           "De flesta kan inte beskriva vad de vill bygga. Det är därför AI inte fungerar. Vibemaster löser det.",
    ...
    "hero.positioning":   "Vibemaster är lagret mellan idé och AI-byggande.",
    ...
    "faq.a3":             "ChatGPT och Claude ger dig svar. Vibemaster ger dig en byggbar produkt-specifikation. Istället för ett samtal får du en strukturerad plan med features, user flows, datamodell och instruktioner som AI kan bygga från.",
