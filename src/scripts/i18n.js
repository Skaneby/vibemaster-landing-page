...
const translations = {
  ...
  en: {
    ...
    "faq.a1":             "No, Vibemaster is built to remove the need for technical knowledge. Through an intuitive interview process, it acts as your personal Tech Lead. Instead of writing complex code, Vibemaster asks intelligent follow-up questions (up to two per step) to uncover the technical details required. We then translate your vision into a ready-made tech plan that AI builders like <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a> or <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a> understand perfectly.",
    "faq.q2":             "How does Vibemaster differ from just using ChatGPT or Claude?",
    "faq.a2":             "Vibemaster bridges the prompt gap by extracting technical logic that regular AI models often miss. While <a href="https://chatgpt.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">ChatGPT</a> or <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a> assume you know what to ask, Vibemaster takes control of the dialogue. We analyze your idea to identify database structures, API routes, and edge cases. The result is an optimized technical specification that eliminates the circular errors that arise when giving an AI builder vague instructions.",
    "faq.q3":             "Which tools can I use together with Vibemaster?",
    "faq.a3":             "Vibemaster generates universal technical plans and prompts that work with all leading AI coding services. We are optimized for a seamless workflow with tools like <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google AI Studio</a>, <a href="https://lovable.dev" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Lovable</a>, <a href="https://replit.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Replit</a>, <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a>, <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a>, and <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a>. Once your tech plan is generated, you can copy the instructions directly into your favorite IDE and watch your product come to life in real time without guesswork.",
    "faq.q4":             "Is my data secure and do you comply with EU regulations?",
    "faq.a4":             "Yes, Vibemaster is an EU-First platform that is fully GDPR-compliant and prepared for the EU AI Act. All data is stored on European infrastructure via <a href="https://scalingo.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Scalingo</a> in Paris. Unlike many American services, we never use your proprietary ideas or data to train global AI models. For Professional users, we also offer Bring Your Own Key (BYOK), giving you full control over your data traffic.",
  ...
  de: {
    ...
    "faq.a1":             "Nein, Vibemaster ist speziell entwickelt, um technisches Wissen überflüssig zu machen. Durch einen intuitiven Interviewprozess fungiert der Service als dein persönlicher Tech Lead. Statt komplexen Code zu schreiben, stellt Vibemaster intelligente Rückfragen (bis zu zwei pro Schritt), um die benötigten technischen Details zu erschließen. Wir übersetzen dann deine Vision in einen fertigen Tech-Plan, den KI-Builder wie <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a> oder <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a> perfekt verstehen.",
    "faq.q2":             "Wie unterscheidet sich Vibemaster vom einfachen Nutzen von ChatGPT oder Claude?",
    "faq.a2":             "Vibemaster überbrückt die Prompt-Lücke, indem es technische Logik extrahiert, die reguläre KI-Modelle häufig übersehen. Während <a href="https://chatgpt.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">ChatGPT</a> oder <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a> davon ausgehen, dass du weißt, was du fragen musst, übernimmt Vibemaster die Kontrolle über den Dialog. Wir analysieren deine Idee, um Datenbankstrukturen, API-Routen und Randfälle zu identifizieren. Das Ergebnis ist eine optimierte technische Spezifikation, die häufige Endlosschleifen eliminiert.",
    "faq.q3":             "Welche Tools kann ich zusammen mit Vibemaster nutzen?",
    "faq.a3":             "Vibemaster generiert universelle technische Pläne und Prompts, die mit allen führenden KI-Coding-Diensten funktionieren. Wir sind für einen nahtlosen Workflow mit Tools wie <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google AI Studio</a>, <a href="https://lovable.dev" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Lovable</a>, <a href="https://replit.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Replit</a>, <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a>, <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a> und <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a> optimiert. Sobald dein Tech-Plan erstellt ist, kannst du die Anweisungen direkt in deine bevorzugte IDE kopieren und zusehen, wie dein Produkt in Echtzeit entsteht.",
    "faq.q4":             "Sind meine Daten sicher und erfüllt ihr die EU-Vorschriften?",
    "faq.a4":             "Ja, Vibemaster ist eine EU-First-Plattform, die vollständig DSGVO-konform und für den EU AI Act vorbereitet ist. Alle Daten werden auf europäischer Infrastruktur über <a href="https://scalingo.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Scalingo</a> in Paris gespeichert. Im Gegensatz zu vielen amerikanischen Diensten verwenden wir deine proprietären Ideen oder Daten niemals zum Training globaler KI-Modelle. Für Professional-Nutzer bieten wir zudem Bring Your Own Key (BYOK) an.",
  ...
  es: {
    ...
    "faq.a1":             "No, Vibemaster está construido específicamente para eliminar la necesidad de conocimientos técnicos. A través de un proceso de entrevista intuitivo, actúa como tu Tech Lead personal. En lugar de escribir código complejo, Vibemaster hace preguntas de seguimiento inteligentes (hasta dos por paso) para descubrir los detalles técnicos necesarios. Luego traducimos tu visión a un plan técnico listo que los constructores de IA como <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a> o <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a> entienden perfectamente.",
    "faq.q2":             "¿En qué se diferencia Vibemaster de simplemente usar ChatGPT o Claude?",
    "faq.a2":             "Vibemaster cierra la brecha de prompts extrayendo la lógica técnica que los modelos de IA habituales suelen pasar por alto. Mientras que <a href="https://chatgpt.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">ChatGPT</a> o <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a> asumen que sabes qué preguntar, Vibemaster toma el control del diálogo. Analizamos tu idea para identificar estructuras de base de datos, rutas API y casos extremos. El resultado es una especificación técnica optimizada que elimina los errores circulares habituales.",
    "faq.q3":             "¿Qué herramientas puedo usar junto con Vibemaster?",
    "faq.a3":             "Vibemaster genera planes técnicos universales y prompts que funcionan con todos los servicios de codificación IA líderes. Estamos optimizados para un flujo de trabajo fluido con herramientas como <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google AI Studio</a>, <a href="https://lovable.dev" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Lovable</a>, <a href="https://replit.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Replit</a>, <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a>, <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a> y <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a>. Una vez generado tu plan técnico, puedes copiar las instrucciones directamente a tu IDE favorito y ver tu producto construido en tiempo real sin conjeturas.",
    "faq.q4":             "¿Mis datos están seguros y cumplen con la normativa de la UE?",
    "faq.a4":             "Sí, Vibemaster es una plataforma EU-First que cumple completamente con el RGPD y está preparada para la Ley de IA de la UE. Todos los datos se almacenan en infraestructura europea a través de <a href="https://scalingo.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Scalingo</a> en París. A diferencia de muchos servicios americanos, nunca utilizamos tus ideas propietarias o datos para entrenar modelos de IA globales. Para usuarios Professional, también ofrecemos Bring Your Own Key (BYOK).",
  ...
  fr: {
    ...
    "faq.a1":             "Non, Vibemaster est spécifiquement conçu pour supprimer le besoin de connaissances techniques. Grâce à un processus d'entretien intuitif, il agit comme ton Tech Lead personnel. Au lieu d'écrire du code complexe, Vibemaster pose des questions de suivi intelligentes (jusqu'à deux par étape) pour extraire les détails techniques nécessaires. Nous traduisons ensuite ta vision en un plan technique prêt à l'emploi que les constructeurs IA comme <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a> ou <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a> comprennent parfaitement.",
    "faq.q2":             "En quoi Vibemaster diffère-t-il du simple usage de ChatGPT ou Claude?",
    "faq.a2":             "Vibemaster comble le fossé des prompts en extrayant la logique technique que les modèles IA classiques ratent souvent. Là où <a href="https://chatgpt.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">ChatGPT</a> ou <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a> supposent que tu sais quoi demander, Vibemaster prend le contrôle du dialogue. Nous analysons ton idée pour identifier les structures de base de données, les routes API et les cas limites. Le résultat est une spécification technique optimisée qui élimine les erreurs circulaires habituelles.",
    "faq.q3":             "Quels outils puis-je utiliser avec Vibemaster?",
    "faq.a3":             "Vibemaster génère des plans techniques universels et des prompts compatibles avec tous les principaux services de codage IA. Nous sommes optimisés pour un flux de travail fluide avec des outils comme <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google AI Studio</a>, <a href="https://lovable.dev" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Lovable</a>, <a href="https://replit.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Replit</a>, <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a>, <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a> et <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a>. Une fois ton plan technique généré, tu peux copier les instructions directement dans ton IDE préféré et voir ton produit prendre vie en temps réel.",
    "faq.q4":             "Mes données sont-elles sécurisées et respectez-vous la réglementation européenne?",
    "faq.a4":             "Oui, Vibemaster est une plateforme EU-First entièrement conforme au RGPD et préparée pour la Loi IA de l'UE. Toutes les données sont stockées sur une infrastructure européenne via <a href="https://scalingo.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Scalingo</a> à Paris. Contrairement à de nombreux services américains, nous n'utilisons jamais tes idées propriétaires ou tes données pour entraîner des modèles IA globaux. Pour les utilisateurs Professional, nous proposons également le Bring Your Own Key (BYOK).",
  ...
  hi: {
    ...
    "faq.a1":             "नहीं, Vibemaster विशेष रूप से तकनीकी ज्ञान की जरूरत को खत्म करने के लिए बनाया गया है। एक सहज साक्षात्कार प्रक्रिया के माध्यम से यह आपके व्यक्तिगत Tech Lead के रूप में काम करता है। जटिल कोड लिखने के बजाय, Vibemaster बुद्धिमान अनुवर्ती प्रश्न पूछता है ताकि आवश्यक तकनीकी विवरण निकाले जा सकें। फिर हम आपकी दृष्टि को एक तैयार tech plan में अनुवादित करते हैं जिसे <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a> या <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a> जैसे AI builder पूरी तरह समझते हैं।",
    "faq.q2":             "Vibemaster सिर्फ ChatGPT या Claude उपयोग करने से कैसे अलग है?",
    "faq.a2":             "Vibemaster prompt gap को पाटता है — उस तकनीकी तर्क को निकालकर जो <a href="https://chatgpt.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">ChatGPT</a> या <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a> जैसे सामान्य AI मॉडल अक्सर चूक जाते हैं। Vibemaster संवाद पर नियंत्रण लेकर डेटाबेस संरचना, API रूट और edge cases की पहचान करता है। परिणाम एक अनुकूलित तकनीकी विशिष्टता है जो circular errors को खत्म करती है।",
    "faq.q3":             "मैं Vibemaster के साथ कौन से tools उपयोग कर सकता हूं?",
    "faq.a3":             "Vibemaster सार्वभौमिक तकनीकी योजनाएं और prompts बनाता है जो सभी प्रमुख AI coding सेवाओं के साथ काम करते हैं। हम <a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google AI Studio</a>, <a href="https://lovable.dev" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Lovable</a>, <a href="https://replit.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Replit</a>, <a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a>, <a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a> और <a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a> जैसे tools के साथ निर्बाध workflow के लिए अनुकूलित हैं। आपका tech plan तैयार होने के बाद, आप निर्देशों को सीधे अपने पसंदीदा IDE में copy करके अपना product real-time में बनते हुए देख सकते हैं।",
    "faq.q4":             "क्या मेरा डेटा सुरक्षित है और क्या आप EU नियमों का पालन करते हैं?",
    "faq.a4":             "हां, Vibemaster एक EU-First प्लेटफॉर्म है जो पूरी तरह GDPR-अनुपालक है और EU AI Act के लिए तैयार है। सभी डेटा Paris में <a href="https://scalingo.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Scalingo</a> के माध्यम से यूरोपीय बुनियादी ढांचे पर संग्रहीत किया जाता है। हम वैश्विक AI मॉडल को प्रशिक्षित करने के लिए आपके विचारों या डेटा का उपयोग कभी नहीं करते। Professional उपयोगकर्ताओं के लिए हम Bring Your Own Key (BYOK) भी प्रदान करते हैं।",
  ...
  zh: {
    ...
    "faq.a1":             "不需要，Vibemaster专门设计用于消除对技术知识的需求。通过直观的访谈流程，它充当您的个人Tech Lead。Vibemaster提出智能追问来挖掘所需的技术细节，然后将您的愿景转化为<a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a>或<a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a>等AI构建工具能完美理解的现成技术方案。",
    "faq.q2":             "Vibemaster与直接使用ChatGPT或Claude有何不同？",
    "faq.a2":             "Vibemaster通过提取<a href="https://chatgpt.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">ChatGPT</a>或<a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a>等普通AI模型经常遗漏的技术逻辑来弥合提示差距。Vibemaster主导整个对话流程，分析您的想法以识别数据库结构、API路由和边缘情况，生成优化的技术规格，消除循环报错。",
    "faq.q3":             "我可以将Vibemaster与哪些工具配合使用？",
    "faq.a3":             "Vibemaster生成通用技术方案和提示，适用于所有主流AI编程服务。我们针对<a href="https://aistudio.google.com/" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Google AI Studio</a>、<a href="https://lovable.dev" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Lovable</a>、<a href="https://replit.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Replit</a>、<a href="https://bolt.new" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Bolt.new</a>、<a href="https://cursor.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Cursor</a>和<a href="https://claude.ai" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Claude</a>等工具优化了无缝工作流程。技术方案生成后，您可以直接将指令复制到您最喜欢的IDE中，实时看到产品构建完成。",
    "faq.q4":             "我的数据安全吗？你们遵守欧盟法规吗？",
    "faq.a4":             "是的，Vibemaster是一个EU-First平台，完全符合GDPR并为欧盟AI法案做好了准备。所有数据通过位于巴黎的<a href="https://scalingo.com" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 underline underline-offset-2 transition-colors">Scalingo</a>存储在欧洲基础设施上。我们从不使用您的专有想法或数据来训练全球AI模型。对于Professional用户，我们还提供自带密钥（BYOK）。",
